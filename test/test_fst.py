...
class MutableFSTTestCase(TestCase):
    ...
    def test_add_transition(self):
        ...
        self.assertEqual(f.to_dict(),
                         {'initial': s0, 'finals': [], 'transitions': {s0: {'a': s1, 'b': s2}, s1: {}, s2: {}}})
        t = f.get_target(s0, 'b')
        ...
        self.assertEqual(f.to_dict(),
                         {'initial': s0, 'finals': [], 'transitions': {s0: {'a': s1, 'b': s2}, s1: {'a': s0}, s2: {}}})
        t = f.get_target(s1, 'a')
        self.assertEqual(t, s0)
        # s0 a s2
        f.add_transition(s0, 'a', s2)
        self.assertEqual(f.to_dict(),
                         {'initial': s0, 'finals': [], 'transitions': {s0: {'a': s2, 'b': s2}, s1: {'a': s0}, s2: {}}})
        t = f.get_target(s0, 'a')
        self.assertEqual(t, s2)
